...
| 编号 | 名称 | 用途 | 触发条件 | 主文件 |
|------|------|------|---------|--------|
| FR-001 | 原子攻击 | 高密度信息点持续刺激注意力 | 干货清单、认知刷新 | `frames/FR-001-atom-info/` |
| BR-001 | 品牌拆解型 | 拆解品牌案例，展示KOL营销价值 | "拆解XX品牌""品牌拆解" | `business/品牌出海/品牌拆解型/prompt.md` |

**BR-001 交付流程**：读取 prompt.md → 按两阶段交付（文案脚本 250-300字 + 素材清单）
